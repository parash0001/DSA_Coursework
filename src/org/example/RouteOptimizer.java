...
public class RouteOptimizer extends JFrame {
    ...
    private void initializeCitiesAndDistances() {
        ...
        cityPositions.put("Arizona", new Point(200, 100));
        cityPositions.put("Kansas", new Point(100, 300));
        cityPositions.put("Colorado", new Point(400, 150));
        cityPositions.put("Florida", new Point(300, 400));
        cityPositions.put("Texas", new Point(500, 300));
        cityPositions.put("Maryland", new Point(600, 200));

        // Initialize cities and their indices
        String[] cities = {"Arizona", "Kansas", "Colorado", "Florida", "Texas", "Maryland"};
        ...
        addConnection("Arizona", "Kansas", 200);
        addConnection("Kansas", "Florida", 50);
        addConnection("Florida", "Maryland", 150);
        addConnection("Maryland", "Texas", 50);
        addConnection("Colorado", "Maryland", 55);
        addConnection("Colorado", "Kansas", 200);
    }
